            ...
            <div class="flex -mx-4 flex-wrap">
                ...
                <div class="w-full px-4 mb-4 md:w-8/12 md:mb-0" id="shopping-cart">
                    ...
                    @foreach ($shopping_cart as $cart)
                        <div class="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="{{ $cart['id'] }}">
                            <div class="px-4 flex-none">
                                <div style="width: 90px; height: 90px">
                                    <img src="./images/upload_images/{{ $cart['image1'] }}" alt="chair office 1"
                            ...
                            <div class="px-4 w-auto md:w-5/12 flex-1">
                                <div>
                                    ...
                                    @endphp
                                    <span
                                        class="text-sm md:text-lg">{{ ucfirst($category[0]) . ' ' . ucfirst($category[1]) }}</span>
                            ...
                            <div class="px-4 w-auto md:w-5/12 md:flex-1 hidden md:block">
                                <div>
                                    <h6 class="font-semibold text-lg" data-price="{{ $cart['price'] }}">IDR
                            ...
                            <div class="px-4 w-2/12">
                                <div class="text-center">
                                    <button data-delete-item="{{ $cart['id'] }}"
                    ...
                    @if (count($shopping_cart) != 0)
                        <div class="px-4 w-auto md:w-full mx-auto total">
                            <div>
                                <h6 class="text-base md:text-lg block md:hidden ml-12">
                                    Total: <b>IDR {{ number_format($total + $total * 0.11, 0, ',', '.') }}</b>
                    ...
                    <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
                        <form action="" method="POST">
                            ...
                            <div class="flex flex-col mb-4">
                                <label for="complete-name" class="text-sm">Complete Name</label>
                                <input name="name" type="text" id="complete-name" required
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input name="email_address" required type="email" value="{{ old('email_address') }}"
                                    id="email-address"
                                    class="border border-gray-200 rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none"
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input required name="address" type="text" value="{{ old('address') }}" id="address"
                                    class="border border-gray-200 rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none"
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input required name="phone_number" type="tel" value="{{ old('phone_number') }}"
                                    id="phone-number"
                                    class="border border-gray-200 rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none"
                                ...
                                <div class="flex -mx-2 flex-wrap">
                                    ...
                                    <div class="px-2 w-6/12 h-24 mb-4">
                                        ...
                                        <button type="button"
                                            ...
                                            <img src="{{ asset('images/content/courier/logo-fedex.png') }}"
                                                alt="fedex" class="object-contain max-h-full" />
                                        </button>
                                    </div>
                                    <!-- END: courier 1 -->
                                    ...
                                    <div class="px-2 w-6/12 h-24 mb-4">
                                        ...
                                        <button type="button"
                                            class="border-1 border-gray-200 focus:outline-none flex items-center justify-center rounded-xl bg-white w-full h-full">
                                            <img src="{{ asset('images/content/courier/logo-dhl.png') }}" alt="dhl"
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <div class="flex -mx-2 flex-wrap">
                                    ...
                                    <div class="px-2 w-6/12 h-24 mb-4">
                                        ...
                                        <button type="button"
                                            class="border-1 border-gray-200 focus:outline-none flex items-center justify-center rounded-xl bg-white w-full h-full">
                                            <img src="{{ asset('images/content/payment/logo-midtrans.png') }}"
                                                alt="midtrans" class="object-contain max-h-full" />
                                        </button>
                                    </div>
                                    <!-- END: payment 1 -->
                                    ...
                                    <div class="px-2 w-6/12 h-24 mb-4">
                                        ...
                                        <button type="button"
                                            class="border-1 border-gray-200 focus:outline-none flex items-center justify-center rounded-xl bg-white w-full h-full">
                                            <img src="{{ asset('images/content/payment/logo-mastercard.png') }}"
                                                alt="mastercard" class="object-contain max-h-full" />
                                        </button>
                                    </div>
                                    <!-- END: payment 2 -->
                                    ...
                                    <div class="px-2 w-6/12 h-24 mb-4">
                                        ...
                                        <button type="button"
                                            class="border-1 border-gray-200 focus:outline-none flex items-center justify-center rounded-xl bg-white w-full h-full">
                                            <img src="{{ asset('images/content/payment/logo-bitcoin.png') }}"
                                                alt="bitcoin" class="object-contain max-h-full" />
                                        </button>
                                    </div>
                                    <!-- END: payment 3 -->
                                    ...
                                    <div class="px-2 w-6/12 h-24 mb-4">
                                        ...
                                        <button type="button"
                                            class="border-1 border-gray-200 focus:outline-none flex items-center justify-center rounded-xl bg-white w-full h-full">
                                            <img src="{{ asset('images/content/payment/logo-american-express') }}.png"
                            ...
                            <div class="text-center">
                                <button type="submit"
                                    class="bg-pink-400 text-black hover:bg-black hover:outline-none w-full py-3 rounded-full text-lg hover:text-pink-400 transition-all duration-200 px-6">
                                    Checkout Now
                                </button>
                            </div>
                        </form>
