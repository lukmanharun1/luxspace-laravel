...
@section('content')
            ...
            <div class="flex flex-strech items-center">
                ...
                <div class="w-auto">
                    <ul class="flex item-center">
                        ...
                        <li class="ml-6">
                            <a id="header-cart" href="{{ url('/cart') }}"
        ...
        <div class="container mx-auto">
            ...
            <div class="grid grid-rows-2 grid-cols-9 gap-4">
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-4 card" style="height: 180px">
                    ...
                    <a href="{{ route('category-rooms', 'living_room') }}" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-2 md:row-span-2 card">
                    ...
                    <a href="{{ route('category-rooms', 'decoration_room') }}" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-3 md:row-span-2 card">
                    ...
                    <a href="{{ route('category-rooms', 'bed_room') }}" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-4 card">
                    ...
                    <a href="{{ route('category-rooms', 'children_room') }}" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
    ...
    <section class="flex flex-col py-16">
        ...
        <div class="overflow-x-scroll px-4 pb-7" id="carousel">
                ...
                @foreach ($just_arrived as $arrived)
                    ...
                    <div class="px-4 relative card">
                        <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                            ...
                            <img src="{{ asset('images/upload_images/' . $arrived->image1) }}" alt="just arrived"
                                class="w-full h-full object-cover object-center" />

                            {{-- START: icon details (mata) --}}
                            <div class="absolute inset-0 rounded-xl hidden items-center justify-center"
    ...
    <div class="container mx-auto py-8">
        <div class="flex justify-center flex-wrap">
            <div class="w-full flex auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('images/content/logo-adobe.png') }}" alt="logo adobe" class="mx-auto" />
            </div>

            <div class="w-full flex auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('images/content/logo-ikea.png') }}" alt="logo ikea" class="mx-auto" />
            </div>

            <div class="w-full flex auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('images/content/logo-herman-miller.png') }}" alt="logo herman-miller"
                    class="mx-auto" />
            </div>

            <div class="w-full flex auto md:w-auto md:flex-initial px-4 md:px-6 my-4 md:my-0">
                <img src="{{ asset('images/content/logo-miele.png') }}" alt="logo miele" class="mx-auto" />
            </div>
        </div>
    </div>
    <!-- END: Clients -->
