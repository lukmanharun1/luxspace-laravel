                ...
                <div class="w-full md:w-3/12 mb-4 md:mb-0">
                    ...
                    <form action="#">
                        <label class="relative w-full">
                            <input type="text"
                                class="bg-gray-100 rounded-xl py-3 px-5 w-full border-none focus:ring-0"
                                placeholder="Your email adress" />
                            <button
                                class="bg-pink-400 hover:bg-black text-white hover:text-pink-400 absolute rounded-xl right-0 p-3">
