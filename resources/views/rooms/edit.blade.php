    ...
    <form action="" method="POST" enctype="multipart/form-data" class="py-6">
        ...
        <div class="w-3/12 mx-auto">
            ...
            <input type="text" name="name_product"
                ...
                id="name-product" value="{{ $room->name_product }}" />
            @error('name_product')
            ...
            <textarea name="about_product" id="about-product" cols="30" rows="4"
                class="w-full rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none">{{ $room->about_product }}</textarea>
            @error('about_product')
                <span class="text-red-500 font-semibold">{{ $message }}</span>
            @enderror
            {{-- upload image --}}
            ...
            <img src="{{ asset('images/upload_images/' . $room->image1) }}" alt="upload image 1" class="w-24 rounded-sm" />
            ...
            <img src="{{ asset('images/upload_images/' . $room->image2) }}" alt="upload image 2" class="w-24 rounded-sm" />
            ...
            <img src="{{ asset('images/upload_images/' . $room->image3) }}" alt="upload image 3" class="w-24 rounded-sm" />
            ...
            <img src="{{ asset('images/upload_images/' . $room->image4) }}" class="w-24 rounded-sm" alt="not found" />
            ...
            <img src="{{ asset('images/upload_images/' . $room->image5) }}" class="w-24 rounded-sm" alt="not found" />
