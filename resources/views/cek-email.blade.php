        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col items-center justify-center">
                <div class="w-full md:w-4/12 text-center">
                    <img src="{{ asset('images/content/send-email.png') }}" alt="ilustration email send success"
                        class="rounded-lg ml-11" />
                    <h2 class="text-3xl font-semibold my-3">Email Sent Successfully!</h2>
                    <p class="text-lg mb-6">
                        Check Your Email To Make Payment!
                    </p>
                    <a href="/"
                        class="bg-pink-400 text-black hover:bg-black hover:text-pink-400 rounded-full px-8 py-3 inline-block transition duration-200">Back
                        to Shop</a>
                </div>
            </div>
        </div>
