...
@section('content')
    <div class="flex justify-center items-center flex-col">
        ...
        <a href="/"
            class="bg-pink-400 text-black hover:bg-black hover:text-pink-400 rounded-full px-8 py-3 inline-block flex-none transition duration-200 mt-7">
            <svg width="24" height="24" viewBox="0 0 29 25" fill="none" xmlns="http://www.w3.org/2000/svg"
